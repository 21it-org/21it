...
# create authkey for request form

for app in booking_req book_search
do
...
clear
echo "-------------------------------------------------------------------------"
echo "book_search APP is successfully imported."
echo "please tyr to access "
echo "APP: ${base_url}/book_search"
echo "-------------------------------------------------------------------------"
